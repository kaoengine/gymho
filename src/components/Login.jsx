/**
 * We’re gonna call Form validateAll() method to check validation functions in validations.
 * Then CheckButton helps us to verify if the form validation is successful or not.
...
/**
  * This page has a Form with username & password.
  ...
  we call AuthService.login() method,
  then direct user to Profile page: props.history.push("/profile");,
  or show message with response error.
  */

/**
   * For getting the application state and dispatching actions, 
   * we use React Redux Hooks useSelector and useDispatch.
